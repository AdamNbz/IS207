  ...
  return (
    <nav className="flex items-center justify-between px-6 md:px-16 lg:px-32 py-3 border-b border-gray-300 text-gray-700 bg-white relative">
      ...
      <div className="flex items-center gap-4 lg:gap-8 max-md:hidden">
        ...
        <Link href="/about-us" className="hover:text-gray-900 transition">Về chúng tôi</Link>
        <Link href="/contact" className="hover:text-gray-900 transition">Liên hệ</Link>
      </div>
      ...
      <div className="flex items-center md:hidden gap-4">
         ...
         {userData && (
             <span className="text-orange-600 font-bold text-sm">{userData.name}</span>
         )}
      </div>
